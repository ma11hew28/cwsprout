...
/** @scope SC.ListItemView.prototype */ {
   ...
   */
   renderIconHtml: function(icon){
     ...
     if (icon && SC.ImageView.valueIsUrl(icon)) {
       ...
       className = icon; url = '/static/sproutcore/_src/english.lproj/blank.gif?1218940831' ;
     }
     html.push('<img class="sc-icon ');
     html.push(className || '');
     html.push('" src="');
     html.push(url || '/static/sproutcore/_src/english.lproj/blank.gif?1218940831') ;
     html.push('" />') ;
     html=html.join('');
     return html;
   },
  ...
  */
   ...
   renderActionHtml: function(actionClassName){
     var html = [];
     html.push('<img src="') ;
     html.push('/static/sproutcore/_src/english.lproj/blank.gif?1218940831') ;
